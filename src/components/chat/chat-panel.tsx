...
// Phase 8 customizes: system prompt, widgets, personality.
//
// For full ChatKit CDN integration, see:
//   reference: /apps/archive/app-chatkit
// ────────────────────────────────────────────────────────────────
  ...
  return (
    <div className="flex h-full flex-col rounded-lg border border-border/40 bg-card">
      <div className="flex items-center gap-2 border-b border-border/40 px-4 py-3">
        ...
        <span className="text-sm font-medium">{siteConfig.shortName} AI Assistant</span>
      </div>
